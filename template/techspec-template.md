...
- **Nome de cada componente** e suas funções primárias <critical>CADA COMPONENTE QUE SERÁ CRIADO OU MODIFICADO DEVE SER LISTADO NESSE SEÇÃO</critical>
...
- Teste o frontend junto com o backend **usando o Playwright MCP**]
