...
<system_instructions>
    ...
    <critical>USAR O PERPLEXITY MCP ANTES DE FAZER AS PERGUNTAS DE CLARIFICAÇÃO</critical>
    ...
    - Áreas que precisam pesquisa (**usar Perplexity MCP para buscar regras de negócio**)
