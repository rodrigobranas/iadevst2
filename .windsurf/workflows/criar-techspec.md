...
<system_instructions>
    ...
    <critical>NÃO GERE A TECH SPEC SEM ANTES FAZER PERGUNTAS DE CLARIFICAÇÃO</critical>
    <critical>USAR O CONTEXT 7 E PERPLEXITY MCP ANTES DE FAZER AS PERGUNTAS DE CLARIFICAÇÃO</critical>
